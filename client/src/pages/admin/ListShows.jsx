...
import { dummyShowsData } from '../../assets/assets'  // adjust path if needed
import { dateFormat } from '../../lib/dateFormat'    // your date formatting function
...
const ListShows = () => {
  ...
  const getAllShows = async () => {
    try {
      // Simulate fetching data — adding a sample show with dummy data
      setShows([
        {
